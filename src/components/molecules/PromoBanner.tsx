...
const promos: Promo[] = [
  {
    ...
    description: 'Reserva la Suite Jacuzzi rato de 3 horas por solo $150.000 Todos los días 🤪.',
  ...
  },
  {
    ...
    description: 'Disfruta de la suite por más tiempo con check-out tardío gratuito y desayuno 🥣 incluido para dos personas.',
