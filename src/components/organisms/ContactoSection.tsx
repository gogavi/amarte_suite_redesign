      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="font-heading text-3xl md:text-4xl text-white uppercase mb-6">
            CONTACTO Y <span className="text-[#E6007E]">UBICACIÓN</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 py-3 rounded-xl bg-[#E6007E] hover:bg-[#E6007E]/90 text-white font-heading text-xs uppercase tracking-widest text-center transition-colors duration-200 shadow-[0_0_12px_rgba(230,0,126,0.2)]"
            >
              🗺️ ABRIR GOOGLE MAPS
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white font-heading text-xs uppercase tracking-widest text-center transition-colors duration-200"
            >
              🚙 IR POR WAZE
            </a>
          </div>
        ...
        <div className="rounded-2xl bg-[#17171E] border border-white/5 p-8 relative overflow-hidden flex flex-col justify-center items-center text-center min-h-[300px]">
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-[#E6007E]/10 rounded-full pointer-events-none"
            aria-hidden="true"
          />
          ...
          <div className="flex gap-6 relative z-[1]">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`${socialLinkClass} border border-[#E6007E]/40 hover:border-[#E6007E] hover:shadow-[0_0_20px_rgba(230,0,126,0.3)]`}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`${socialLinkClass} border border-white/20 hover:border-white hover:shadow-[0_0_20px_rgba(255,255,255,0.15)]`}
              aria-label="Facebook"
            >
