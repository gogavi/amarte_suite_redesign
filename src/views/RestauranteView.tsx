...
export default function RestauranteView({ onBack, onSelectDish }: RestauranteViewProps) {
  return (
    <div className="min-h-screen bg-[#0D0D11] text-[#FFF5F8] py-16 px-6 relative">
      {/* Lights background */}
      <div className="absolute top-10 right-10 w-72 h-72 bg-[#19A6E0]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          <h1 className="font-heading text-4xl md:text-5xl text-white uppercase mt-2">
            RESTAURANTE <span className="text-[#E6007E] filter drop-shadow-[0_0_12px_rgba(230,0,126,0.25)]">GOURMET</span>
          </h1>
